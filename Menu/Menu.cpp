...
Ressource *Menu::demanderInfoRessources() {
    ...
    std::getline(std::cin, anneeCreation);

    switch (type) {
        case 1:
            return demanderInfoLivre(titre, auteur, stoi(anneeCreation));
        case 2:
            return demanderInfoRevue(titre, auteur, stoi(anneeCreation));
        case 3:
            return demanderInfoCd(titre, auteur, stoi(anneeCreation));
        case 4:
            return demanderInfoVhs(titre, auteur, stoi(anneeCreation));
        case 5:
            return demanderInfoDVD(titre, auteur, stoi(anneeCreation));
        case 6:
            return demanderInfoNumerique(titre, auteur, stoi(anneeCreation));
        default:
...
Ressource *Menu::demanderInfoLivre(string titre, string auteur, int annee) {
    std::string nbPages;
...
Ressource *Menu::demanderInfoRevue(string titre, string auteur, int annee) {
    std::string nbPages;
    std::string collection;
    std::string resume;
    std::string editeur;
    std::map<int, string> articles;
...
Ressource *Menu::demanderInfoCd(string titre, string auteur, int annee) {
    std::string duree;
    std::string nbPistes;
...
Ressource *Menu::demanderInfoVhs(string titre, string auteur, int annee) {
    std::string duree;
    std::string maisonProd;
...
Ressource *Menu::demanderInfoDVD(string titre, string auteur, int annee) {
    std::string duree;
    std::string maisonProd;
    std::string nbPistes;
...
Ressource *Menu::demanderInfoNumerique(string titre, string auteur, int annee) {
    std::string type;
    std::string taille;
    std::string url;
